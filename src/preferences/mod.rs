use {
    self::prelude::*,
    crate::{prelude::*, puzzle::transformation::GenusIndex},
    bevy::prelude::World,
...
pub mod prelude {
    pub use {
        super::{
            colors::{ColAndMat, ColorData, ColorDataWithMat},
            FileMenuData, Preferences, RandomizationParams, RandomizationType, Update,
        },
        crate::{
            piece::Design,
            puzzle::transformation::GenusIndexBitArray,
            tools::ToolsData,
            ui::{camera::LightAndCameraData, input::InputData, UIData},
        },
    };
}
